...
namespace GUIVoid.GameObjects.UGW
{
	partial class FontManager
	{
		...
		private void InitializeComponents()
		{
			...
			this._GUIVoid_bold				= _generate();
			this._GUIVoid_regular			= _generate();
			...
			byte[] _GUIVoid_bold_ 			= _fromRes(GUIVoidTTBoldFileInRes);
			byte[] _GUIVoid_regular_ 		= _fromRes(GUIVoidTTRFileInRes);
			...
			this._GUIVoid_bold?.AddFont(_GUIVoid_bold_);
			this._GUIVoid_bold?.AddFont(_noto_sans_regular_);
			this._GUIVoid_regular?.AddFont(_GUIVoid_regular_);
			this._GUIVoid_regular?.AddFont(_noto_sans_regular_);
			this._noto_sans_regular?.AddFont(_noto_sans_regular_);
			this._noto_sans_regular?.AddFont(_GUIVoid_bold_);
			//---------------------------------------------
			//localFunctions:
