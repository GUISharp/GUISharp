...
namespace GUIVoid.SandBox.ErrorSandBoxes
{
    partial class LogOutWarningSandBox
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.ExitButton.ChangeFont(FontManager.GetSprite(GUIVoid_Fonts.GUIVoid_tt_regular, 15));
            this.RetryButton.ChangeFont(FontManager.GetSprite(GUIVoid_Fonts.GUIVoid_tt_regular, 15));
