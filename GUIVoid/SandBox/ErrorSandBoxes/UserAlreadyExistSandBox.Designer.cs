...
namespace GUIVoid.SandBox.ErrorSandBoxes
{
    partial class UserAlreadyExistSandBox
    {
        ...
        private void InitializeComponent()
        {
            ...
            //loading:
            this.LeftTexture = 
				BigRes.GetAsTexture2D(LEFT_BABYLONIA_ENTRANCE);
            this.RightTexture = 
				BigRes.GetAsTexture2D(RIGHT_BABYLONIA_ENTRANCE);
            this.LineTexture = 
				BigRes.GetAsTexture2D(LINE_BABYLONIA_ENTRANCE);
            //names:
            ...
            //fontAndTextAligns:
            this.TitleElement.ChangeFont(FontManager.GetSprite(GUIVoid_Fonts.GUIVoid_tt_regular, 18));
            this.BodyElement.ChangeFont(FontManager.GetSprite(GUIVoid_Fonts.GUIVoid_tt_regular, 16));
            this.BackButton.ChangeFont(FontManager.GetSprite(GUIVoid_Fonts.GUIVoid_tt_regular, 15));
