...
namespace GUIVoid.Client
{
	partial class GClient
	{
		...
		private void MF_InitializeComponents()
		{
			...
			//fontAndTextAligns:
			this.FirstFlatElement.ChangeFont(this.FontManager.GetSprite(GUIVoid_Fonts.GUIVoid_tt_regular, 19));
			test.ChangeFont(this.FontManager.GetSprite(GUIVoid_Fonts.GUIVoid_tt_regular, 19));
			_f1.ChangeFont(this.FontManager.GetSprite(GUIVoid_Fonts.GUIVoid_tt_regular, 19));
			_f2.ChangeFont(this.FontManager.GetSprite(GUIVoid_Fonts.GUIVoid_tt_regular, 19));
			...
			//fontAndTextAligns:
			this.FirstFlatElement.ChangeFont(this.FontManager.GetSprite(GUIVoid_Fonts.GUIVoid_tt_regular, 26));
			testInput.ChangeFont(this.FontManager.GetSprite(GUIVoid_Fonts.GUIVoid_tt_regular, 25));
			this.FirstFlatElement.ChangeAlignmation(StringAlignmation.MiddleCenter);
		...
		private void InitializeMainEvents()
		{
			...
			test.BaseAddress = new Uri("https://GUIVoid-game.herokuapp.com");
