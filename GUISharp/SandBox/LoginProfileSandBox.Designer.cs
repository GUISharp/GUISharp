...
namespace GUISharp.SandBox
{
	partial class LoginProfileSandBox
	{
		...
		private void InitializeComponent()
		{
			...
			//fontAndTextAligns:
			this.TitleElement.ChangeFont(FontManager.GetSprite(GUISharp_Fonts.GUISharp_tt_regular, 22));
			this.BodyElement.ChangeFont(FontManager.GetSprite(GUISharp_Fonts.GUISharp_tt_regular, 20));
			this.ExitButton.ChangeFont(FontManager.GetSprite(GUISharp_Fonts.GUISharp_tt_regular, 19));
